      ...
      <div className="container mx-auto px-4" ref={ref}>
        ...
        <div className="grid lg:grid-cols-2 gap-20 items-center mb-20">
          ...
          >
            ...
            <motion.div
              className="flex items-center gap-6 p-8 bg-gradient-to-r from-orange-100 to-yellow-100 rounded-3xl shadow-lg"
            ...
            >
              ...
              <div>
                <h4 className="font-bold text-xl text-gray-800 mb-2">Innovation First</h4>
                <p className="text-gray-600 text-lg">Turning ideas into impactful solutions</p>
              </div>
            </motion.div>

            <motion.div
              className="flex items-center gap-6 p-8 bg-gradient-to-r from-yellow-100 to-orange-100 rounded-3xl shadow-lg"
              whileHover={{ scale: 1.02, y: -5 }}
              transition={{ duration: 0.3 }}
            >
              ...
              <div>
                <h4 className="font-bold text-xl text-gray-800 mb-2">Startup Ready</h4>
                <p className="text-gray-600 text-lg">From idea to market-ready product</p>
              </div>
            </motion.div>
          </motion.div>
